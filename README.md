...
# Demo Video
🎥 [Watch the demo](https://github.com/rahulkr08cse/Bangalore-House-Price-Predictor/blob/a512b0db30c5d9cefb40ccbe84e356649a57bde4/BHP_Demo.mp4)
 
## 📌 Features
- Predict home prices using a trained linear regression model
- Dynamic frontend using HTML, CSS, and JavaScript
- Backend powered by Flask
- Nginx used as a reverse proxy for production-like setup
